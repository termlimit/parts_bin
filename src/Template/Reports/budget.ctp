			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title"><?=$year;?> budget report</h3>
					</div>
						...
						<table class="table table-hover sortable table-striped">
							<thead>
								<tr>
									...
									<th class="table-header-repeat <?=$style?>" style="width:100px" title="<?=date("F", mktime(0, 0, 0, $z, 1, $year))?>">
										<span><?=$this->Html->link(
							...
							<tbody>
								<?=$this->cell('BudgetReport::display', [
									'category' => $categories,
									'depth' => 0,
									'display' => 0,
									'showDepth' => 1,
