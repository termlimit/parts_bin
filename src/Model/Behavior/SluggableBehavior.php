 ...
 *
 * @author LF
 * @author https://github.com/UseMuffin/Slug/blob/master/src/Model/Behavior/SlugBehavior.php
 */
...
class SluggableBehavior extends Behavior
{
	...
	{
		//echo '<pre>';print_r($this->_table);exit;
		foreach ((array)$this->config('displayField') as $field) {
			$validator->requirePresence($field, 'create', $this->_table->alias().' requires a title')
				->notEmpty($field, $this->_table->alias().' requires a title');
		}
	}
